...
class RecommendationDataList(SdkBaseModel):
    """List of recommended images"""

    data: Optional[list[Recommendation]] = UNSET
    """Recommended images"""
...
class RecommendationDataListDict(TypedDict):
    data: NotRequired[list[Recommendation | RecommendationDict]]
